          ...
          <div className="p-2 rounded-lg bg-gray-50">
            <div className="flex items-center justify-center gap-1">
              ...
              {stats.accuracyTrend > 0 && (
                <span className="text-green-500 text-2xl" title="Improved from last session">↑</span>
              )}
              {stats.accuracyTrend < 0 && (
                <span className="text-red-500 text-2xl" title="Decreased from last session">↓</span>
              )}
              {stats.accuracyTrend === 0 && (
                <span className="text-gray-400 text-2xl" title="No change or insufficient data">−</span>
              )}
            </div>
